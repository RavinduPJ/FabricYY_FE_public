...
function Index() 
{
    ...
    const tablecolumns = [
      {
        title: 'Action',
        dataIndex: ['fabyy_id','cus_name'],
        width: '5%',
        key: 'id',
        render: (val,val2) => ActionButtonStrip(val,val2),
      },
      {
        title: 'Customer',
        dataIndex: 'cus_name',
    ...
    function ConvertToDatetime(value)
      ...
      function ActionButtonStrip(value,Value2)
      {
        return (<Tooltip title="Edit">
        <Link to={"/"+Value2.cus_name+"/"+Value2.fabyy_id}><Button shape="circle" type="primary" icon={<EditOutlined />} /></Link>
      </Tooltip>);
      }
