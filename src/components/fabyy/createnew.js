                    ...
                    if(data.Type === "SUCCESS")
                    {
                        notification['success']({
                          ...
                          setInterval(() => {
                            ...
                            if(var_customer === 1)
                            {
                              window.location.href = "/pink/"+ data.Data[0].fabyy_id;
                            }
                            else if(var_customer === 2)
                            {
                              window.location.href = "/vs/"+ data.Data[0].fabyy_id;
                            }
                            else if(var_customer === 3)
                            {
                              window.location.href = "/aritzia/"+ data.Data[0].fabyy_id;
                            }
